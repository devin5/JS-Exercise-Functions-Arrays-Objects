...
function getLastCarInfo(inventory) {
  var lastCar = inventory[inventory.length - 1];
...
function sortCarInventory(inventory) {
  return inventory.sort(function(a, b) {
    var textA = a.car_model.toUpperCase();
    var textB = b.car_model.toUpperCase();
...
//     const models = ["Audi", "Mercedes-Benz", "Volkswagen", "BMW"];
//     models.forEach(model => {
//       if (element.car_make == model) {
//         germanCars.push(element);
//       } else {
//         return false;
//       }
//     });
...
function getGermanCars(inventory) {
  ...
  for (var i = 0; i < inventory.length; i++) {
    if (
      inventory[i].car_model === "Audi" ||
      inventory[i].car_model === "Mercedes-Benz" ||
      inventory[i].car_model === "BMW" ||
      inventory[i].car_model === "Volkswagen"
    ) {
